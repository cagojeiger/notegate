...
const MIGRATIONS: &[&str] = &[
    include_str!("../../../db/migrations/0001_extensions.sql"),
    include_str!("../../../db/migrations/0002_identity.sql"),
    include_str!("../../../db/migrations/0003_spaces.sql"),
    include_str!("../../../db/migrations/0004_nodes_content.sql"),
];
