...
#[openapi(
    paths(
        ...
        rest::link_graph::get_node_links,
        ...
        rest::nodes::reveal,
        rest::nodes::update,
        rest::nodes::update_external_access_policy,
    ...
    tags(
        ...
        (name = "links", description = "Derived Markdown link graph"),
...
mod tests {
    ...
    fn openapi_lists_every_resource_api_category() {
        ...
        for path in [
            ...
            "/api/v1/spaces/{space_id}/nodes/{node_id}/children",
            "/api/v1/spaces/{space_id}/nodes/{node_id}/reveal",
            "/api/v1/spaces/{space_id}/nodes/{node_id}/external-access-policy",
