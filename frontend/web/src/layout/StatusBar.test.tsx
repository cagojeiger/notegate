...
describe("StatusBar", () => {
  ...
  it("shows active space usage and new-item defaults", () => {
    ...
    expect(screen.getByRole("img", { name: "MCP & API access for new items: on" })).toBeInTheDocument();
    expect(screen.getByRole("img", { name: "New document encryption is off" })).toBeInTheDocument();
