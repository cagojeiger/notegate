...
export function EditorGroupHeader({ title, icon, navigationActions, titleActions, actions, canClose, onClose, onContextMenu, dirty, active }: { title: string; icon?: ReactNode; navigationActions?: ReactNode; titleActions?: ReactNode; actions?: ReactNode; canClose: boolean; onClose: () => void; onContextMenu?: MouseEventHandler<HTMLDivElement>; dirty?: boolean; active?: boolean }) {
  return (
