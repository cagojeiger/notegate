...
export function PlainTextPreview({ content }: { content: string }) {
  ...
  return (
    <pre ref={preRef} className="mx-auto min-h-0 w-full max-w-[52rem] flex-1 overflow-auto whitespace-pre-wrap px-10 py-14 font-reading text-base leading-7 text-text">
      {content}
    </pre>
  );
}
