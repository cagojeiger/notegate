...
- 10 MiB 이하 PNG, JPEG, WebP, AVIF, GIF, PDF는 실제 bytes에서 media type을 감지한 뒤 별도의 inline preview URL을 발급할 수 있다. PDF는 browser-native viewer로 표시하고 Markdown image에는 사용하지 않는다. SVG, client-encrypted file과 10 MiB 초과 file은 inline preview 대상이 아니다.
